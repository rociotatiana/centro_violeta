...
urlpatterns = [
    ...
    path('actualizar_beneficiaria', views.actualizar_beneficiaria, name = "actualizar_beneficiaria"),
    path('eliminar_beneficiaria', views.eliminarBeneficiaria, name = "eliminar_beneficiaria"),
